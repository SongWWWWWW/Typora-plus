...
- `IIndexService`: asynchronous workspace indexing, cross-file search, and Markdown metadata collection
...
- SQLite-backed index provider for `IIndexService`: persisted search and metadata
