...
- inactive Markdown marker soft hiding for headings, lists, quotes, fences, inline/reference links and images, emphasis, and strikethrough, with inline-code-safe marker scanning
