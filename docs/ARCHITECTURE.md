...
- table block styling with code-fence-aware table detection, escaped-pipe-aware inactive previews, row/column insert tools, targeted deletion controls, and column alignment controls
