...
- table block styling with code-fence-aware table detection, inactive previews that preserve escaped pipes, inline code, inline math, autolinks, inline HTML syntax, and full/collapsed/shortcut link-image syntax, targeted row/column insertion and deletion controls, column alignment controls, and source-focused cell navigation
