...
- source-backed inactive task list checkbox widgets that replace only parsed task markers and dispatch bounded click or focused-keyboard text edits back to the Markdown source
