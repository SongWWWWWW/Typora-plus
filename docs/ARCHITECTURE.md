...
- table block styling with code-fence-aware table detection, escaped-pipe-aware inactive previews, row/column insert/delete tools, and column alignment controls
