...
- table block styling with code-fence-aware table detection, escaped-pipe-, inline-code-, and full/collapsed/shortcut link-image-syntax-aware inactive previews, targeted row/column insertion and deletion controls, column alignment controls, and source-focused cell navigation
