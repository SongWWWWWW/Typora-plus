...
- `IExtensionService`: static extension manifest registration, activation events, and constrained runtime command context
...
- keybindings
- activation events
- activation context with constrained command registration, command execution, command metadata reads, and extension-owned subscriptions
