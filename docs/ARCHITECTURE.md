...
- `IExtensionService`: static extension manifest registration, activation events, and constrained runtime command/context-key APIs
...
- keybindings
- activation events
- activation context with constrained command registration, command execution, command metadata reads, extension-owned context keys, and extension-owned subscriptions
