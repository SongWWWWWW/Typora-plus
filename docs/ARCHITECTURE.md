...
- KaTeX-backed display math preview blocks with TeX copy controls, render diagnostics, and trimmed source-focused click editing
...
- parser-backed math position mapping for broader inline/display edge cases
