...
- platform-level remote sync service boundary for provider-backed workspace mirroring, workspace resource normalization, stable diff planning, execution, and conflict reporting so future Feishu Drive or other cloud integrations stay out of UI code
