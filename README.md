...
- Markdown table block styling with inactive previews that preserve escaped pipes, inline code, inline math, autolinks, and full/collapsed/shortcut link-image syntax, plus targeted row/column insertion and deletion controls, column alignment controls, and source-focused cell navigation
