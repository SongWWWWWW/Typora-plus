...
- built-in Mermaid code-fence preview and Status inline badges through the extension-style Markdown renderer path, with Mermaid lazy-loaded into a separate production chunk
