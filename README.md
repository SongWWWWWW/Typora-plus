...
- Markdown table block styling with escaped-pipe-aware inactive previews, targeted row/column insertion and deletion controls, and column alignment controls
