...
- Settings preferences dialog for appearance, editor, workspace, and searchable keybinding options, including modified-only filtering and reset-all cleanup, opened from the activity bar, command palette, or `Ctrl+,`
