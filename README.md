...
- source-backed task list creation and toggling through inactive checkboxes, focused checkbox keys, and `Mod-Enter` on current, multi-selected, or range-selected list/task lines
