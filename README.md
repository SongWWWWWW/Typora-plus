...
- platform-level extension service for static manifest registration of commands, menus, keybindings, and activation events, with command-derived activation events, a constrained runtime command context, and Workbench default menu/keybinding contributions supplied by a built-in extension manifest
