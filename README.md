...
- platform-level extension service for static manifest registration of commands, menus, keybindings, and activation events, with command-derived activation events and Workbench default menu/keybinding contributions supplied by a built-in extension manifest
