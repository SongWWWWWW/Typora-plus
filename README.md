...
- Markdown table block styling with escaped-pipe-aware inactive previews, row/column insert tools, targeted deletion controls, and column alignment controls
