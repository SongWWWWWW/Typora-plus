...
- platform-level menu contribution and context-key services for titlebar and activitybar actions, with Workbench defaults registered as contributions instead of fixed component button lists
