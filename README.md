...
- renderer preview results are cached with a bounded, configuration-driven LRU in the Workbench adapter so repeated viewport remounts do not re-run heavy providers for identical code fences
